...
def nouns_pl():
    with open ('nouns_pl.txt', encoding='utf-8') as f:
        text = f.read()
...
def nouns_n():
    with open ('nouns_n.txt', encoding='utf-8') as f:
        text = f.read()
        splited_text = text.split()
        nouns_n = []
        for word in splited_text:
...
def nouns_f():
    with open ('nouns_f.txt', encoding='utf-8') as f:
        text = f.read()
        splited_text = text.split()
        nouns_f = []
        for word in splited_text:
...
def adj_n():
    with open ('adj_n.txt', encoding='utf-8') as f:
        text = f.read()
        splited_text = text.split()
        adj_n = []
        for word in splited_text:
...
def nouns_gen():
    with open ('nouns_gen.txt', encoding='utf-8') as f:
        text = f.read()
        splited_text = text.split()
        nouns_gen = []
        for word in splited_text:
...
def trans_verbs():
    with open ('trans_verbs.txt', encoding='utf-8') as f:
        text = f.read()
        splited_text = text.split()
        trans_verbs = []
        for word in splited_text:
...
def intran_verbs():
    with open ('intran_verbs.txt', encoding='utf-8') as f:
        text = f.read()
        splited_text = text.split()
        intran_verbs = []
        for word in splited_text:
...
def conj():
    with open ('conj.txt', encoding='utf-8') as f:
        text = f.read()
        splited_text = text.split()
        conj = []
        for word in splited_text:
